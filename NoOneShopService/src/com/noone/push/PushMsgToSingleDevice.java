...
public class PushMsgToSingleDevice {
    public static void main(String[] args) 
         ...
         */
        String apiKey = "GUkYGzQj3T8KDBeHVRfY71yO";
        String secretKey = "YbuwxoyDH5jZeeudu33h6BLsG8pEwE9g";
